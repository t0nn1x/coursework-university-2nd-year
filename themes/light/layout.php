...
<body>
    ...
    <header>
        ...
        <div class="px-3 py-2 border-bottom mb-3">
            <div class="container d-flex flex-wrap justify-content-center">
                <div class=" search col-12 col-lg-auto mb-2 mb-lg-0 me-lg-auto" >
                    <input id="search-input" type="search" class=" input-block form-control" placeholder="Пошук..." aria-label="Search">
                    <a href="/product/?search=" id="search-btn" class="btn btn-success search-btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                        </svg></a>
                </div>
    ...
    <footer class="py-3 my-4">
        ...
        <p class="text-center text-muted">© 2023 Хробуст Антон</p>
    </footer>
    <script>
        ...
        searchBtn.addEventListener('click', function (e) {
            ...
            let search = searchBtn.getAttribute('href').concat(searchValue);
